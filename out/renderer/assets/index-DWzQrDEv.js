...
function calculateAdvancedScore(query, app, synonyms) {
  const lowerQuery = query.toLowerCase();
  const appName = app.name.toLowerCase();
  const appPath = app.path.toLowerCase();
  if (appName === lowerQuery || appPath === lowerQuery) {
    return { score: 1e3, matchType: "exact" };
  }
...
function intelligentSearch(query, apps, options = {}) {
...
function analyzeUsagePatterns(launchHistory, apps) {
  ...
  for (const item of launchHistory) {
    ...
    existing.frequency++;
    existing.hour = (existing.hour + hour) / 2;
...
function getContextualSuggestions(apps, launchHistory, favorites, options = {}) {
  const { currentAppId, maxSuggestions = 5 } = options;
  const patterns = analyzeUsagePatterns(launchHistory);
  ...
  for (const [appId, pattern] of patterns.entries()) {
    ...
    const daysSinceLastUse = (Date.now() - pattern.lastUsed) / (1e3 * 60 * 60 * 24);
  ...
  for (const favId of favorites) {
    ...
    if (app && !suggestions.find((s) => s.app.id === favId)) {
      const lastUsed = launchHistory.filter((h) => h.id === favId).sort((a, b) => b.timestamp - a.timestamp)[0];
      if (lastUsed) {
        const daysSince = (Date.now() - lastUsed.timestamp) / (1e3 * 60 * 60 * 24);
        if (daysSince < 3) {
          suggestions.push({
            app,
...
function getTimeBasedSuggestions(apps, launchHistory) {
  const now = /* @__PURE__ */ new Date();
...
function getSmartSuggestions(apps, launchHistory, favorites, currentAppId) {
  const contextual = getContextualSuggestions(apps, launchHistory, favorites, { currentAppId });
  const timeBased = getTimeBasedSuggestions(apps);
  ...
  return Array.from(unique.values()).sort((a, b) => b.confidence - a.confidence).slice(0, 8);
}
  ...
  (set, get) => ({
    ...
    filterApps: (query) => {
      ...
      if (!trimmedQuery) {
        ...
        const filtered2 = smartSuggestions.length > 0 ? smartSuggestions.map((s) => s.app).slice(0, maxResults) : apps.slice(0, maxResults);
        set({
          smartSuggestions,
          filteredApps: filtered2
        });
        return filtered2;
      }
...
const ResultsList = ({
  ...
  const [iconCache, setIconCache] = reactExports.useState(/* @__PURE__ */ new Map());
  ...
  const handleContextMenu = async (e, app) => {
    e.preventDefault();
    const isFavorite = favorites.includes(app.id);
    const action = isFavorite ? `¿Eliminar "${app.name}" de favoritos?` : `¿Agregar "${app.name}" a favoritos?`;
    if (confirm(action)) {
      if (isFavorite) {
  ...
  if (isLoading || apps.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "results" });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "results", children: apps.map((app, idx) => {
    const cacheKey = `${app.path}-${app.type}`;
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "li",
      {
        ...
        children: [
          iconUrl ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: iconUrl, className: "app-icon", alt: "" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "app-icon-placeholder", children: "📱" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "item-content", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "name", children: shortName }),
            app.path.length > 60 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "path", children: [
              app.path.substring(0, 60),
              "..."
            ] })
          ] })
        ]
...
const Footer = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "footer", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Enter para abrir • ↑↓ para navegar • Ctrl+Space para abrir • Esc para cerrar" }) });
};
const CalcResult = ({ query, result }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "calc-result calculator-mode", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "calc-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "calc-icon", children: "🧮" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "calc-label", children: "Calculadora" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "calc-expression", children: query }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "calc-equals", children: "=" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "calc-value", children: result }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "calc-hint", children: "Presiona Enter para copiar el resultado" })
  ] });
};
const ConvertResult = ({
  value,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "convert-result", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "convert-equation", children: [
      value,
      " ",
      formatUnit(from),
      " ="
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "convert-value", children: [
      result,
      " ",
      formatUnit(to)
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "convert-hint", children: "Presiona Enter para copiar" })
  ] });
};
const SmartSuggestions = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "smart-suggestions", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "suggestions-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "suggestions-icon", children: "💡" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "suggestions-title", children: "Sugerencias Inteligentes" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "suggestions-list", children: suggestions.map((suggestion, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "li",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "suggestion-content", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "app-name", children: suggestion.app.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "suggestion-reason", children: suggestion.reason })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "confidence-badge", children: [
...
class PomodoroTimer {
  ...
  pause() {
    ...
    if (this.startedAt && !this.pausedAt) {
      ...
      const elapsed = Math.floor((this.pausedAt - this.startedAt) / 1e3);
  ...
  resume() {
    if (this.status.state !== "idle" && !this.intervalId) {
      if (this.pausedAt) {
        const pausedTime = Math.floor((Date.now() - this.pausedAt) / 1e3);
   ...
   */
  static getProgress(status, config) {
...
async function savePomodoroState(status, startedAt, pausedAt, pausedDuration) {
  try {
    ...
    if (typeof window !== "undefined" && window.api && "getConfig" in window.api) {
      ...
      if (pomodoroState && pomodoroState.state !== "idle") {
        ...
        if (pomodoroState.startedAt && !pomodoroState.pausedAt) {
          const elapsed = Math.floor((now - pomodoroState.startedAt) / 1e3) - pomodoroState.pausedDuration;
...
const PomodoroTimerComponent = () => {
    ...
    getPomodoroTimer().then((timer) => {
      ...
      timer.setOnComplete((phase) => {
        if ("Notification" in window && Notification.permission === "granted") {
          const message = phase === "work" ? "¡Pomodoro completado! Toma un descanso." : "¡Descanso terminado! Listo para trabajar.";
      ...
      const updateInterval = setInterval(() => {
        ...
        setStatus((prevStatus) => {
          if (prevStatus.state !== currentStatus.state || prevStatus.timeRemaining !== currentStatus.timeRemaining || prevStatus.currentPomodoro !== currentStatus.currentPomodoro) {
  ...
  if (status.state === "idle") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pomodoro-timer idle", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pomodoro-header", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "pomodoro-icon", children: "🍅" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "pomodoro-label", children: "Pomodoro" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pomodoro-controls", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "pomodoro-btn start", onClick: handleStart, children: "Iniciar Pomodoro" }) }),
      status.totalPomodoros > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pomodoro-stats", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
        "Pomodoros completados: ",
        status.totalPomodoros
      ] }) })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `pomodoro-timer ${status.state}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pomodoro-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "pomodoro-icon", children: getStateEmoji() }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "pomodoro-label", children: getStateLabel() })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pomodoro-time", children: formatTime(status.timeRemaining) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pomodoro-progress", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pomodoro-stats", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
        "Pomodoro #",
        status.currentPomodoro
      ] }),
      status.totalPomodoros > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "pomodoro-total", children: [
        "Total: ",
        status.totalPomodoros
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pomodoro-controls", children: [
      isPaused ? /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "pomodoro-btn resume", onClick: handleStart, children: "Reanudar" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "pomodoro-btn pause", onClick: handlePause, children: "Pausar" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "pomodoro-btn stop", onClick: handleStop, children: "Detener" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "pomodoro-btn reset", onClick: handleReset, children: "Resetear" })
    ] })
  ] });
};
...
function detectWindowCommand(query) {
  const patterns = [
    {
...
function detectCalcCommand(query) {
...
function detectSearchCommand(query) {
...
function detectLaunchCommand(query) {
...
function detectConvertCommand(query) {
...
function detectEducationalCommand(query) {
...
function detectPomodoroCommand(query) {
...
function evaluateMath(expression) {
  try {
    let processed = expression.replace(/\bsin\s*\(/gi, "Math.sin(").replace(/\bcos\s*\(/gi, "Math.cos(").replace(/\btan\s*\(/gi, "Math.tan(").replace(/\bln\s*\(/gi, "Math.log(").replace(/\blog\s*\(/gi, "Math.log10(").replace(/\bsqrt\s*\(/gi, "Math.sqrt(").replace(/\bexp\s*\(/gi, "Math.exp(").replace(/\bpi\b/gi, "Math.PI").replace(/\be\b/g, "Math.E").replace(/\bpow\s*\(/gi, "Math.pow(");
...
function detectCategory(from, to) {
  ...
  for (const category of categories) {
    ...
    if (conversions[from] !== void 0 && conversions[to] !== void 0) {
      return category;
    }
  }
  return null;
...
const Launcher = () => {
  ...
  const [convertResult, setConvertResult] = reactExports.useState(null);
  const [showPomodoro, setShowPomodoro] = reactExports.useState(false);
  const [pomodoroStatus, setPomodoroStatus] = reactExports.useState(null);
  ...
  reactExports.useEffect(() => {
    const loadApps = async () => {
      ...
      try {
        setLoading(true);
        const [config, apps2, launchHistory] = await Promise.all([
  ...
  reactExports.useEffect(() => {
    ...
    if (command.type === "pomodoro") {
      getPomodoroTimer().then((timer) => {
        const pomodoroStatus2 = timer.getStatus();
        if (command.action === "start" && pomodoroStatus2.state === "idle") {
          timer.start();
  ...
  reactExports.useEffect(() => {
    const handleKeyDown = (e) => {
      if (e.key === "Escape") {
        ...
        const showSmartSuggestions2 = !searchQuery.trim() && smartSuggestions.length > 0;
        if (showSmartSuggestions2 && smartSuggestions[activeIndex]) {
  ...
  const handleLaunch = async (app) => {
    ...
    if (command.type === "educational" && command.action === "wikipedia" && command.query) {
      const browser = apps.find(
        (a) => a.name.toLowerCase().includes("chrome") || a.name.toLowerCase().includes("firefox") || a.name.toLowerCase().includes("edge") || a.name.toLowerCase().includes("opera")
      );
      if (browser) {
    ...
    if (command.type === "launch" && command.target) {
      const targetApp = apps.find(
        (a) => a.name.toLowerCase().includes(command.target.toLowerCase()) || a.path.toLowerCase().includes(command.target.toLowerCase())
      );
      if (targetApp) {
  ...
  reactExports.useEffect(() => {
    ...
    checkPomodoro();
    const interval = setInterval(checkPomodoro, 1e3);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overlay", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "panel", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SearchBar,
      {
        ref: searchInputRef,
    ...
    hasActiveSearch && showCalcResult && calcResult && /* @__PURE__ */ jsxRuntimeExports.jsx(CalcResult, { query: calcResult.query, result: calcResult.result }),
    hasActiveSearch && showConvertResult && convertResult && /* @__PURE__ */ jsxRuntimeExports.jsx(
      ConvertResult,
      {
    ...
    hasActiveSearch && showResults && !showSmartSuggestions && /* @__PURE__ */ jsxRuntimeExports.jsx(
      ResultsList,
      {
        apps: filteredApps,
        activeIndex,
    ...
    hasActiveSearch && !showCalcResult && !showConvertResult && !showResults && !showSmartSuggestions && !isLoading && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "no-results", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "No se encontraron resultados" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "hint", children: 'Prueba: "calcula 2+2", "convertir 100 km a millas", "wikipedia: Einstein", "pomodoro"' })
    ] }),
    isPomodoroActive && /* @__PURE__ */ jsxRuntimeExports.jsx(PomodoroTimerComponent, {}),
    !hasActiveSearch && showSmartSuggestions && /* @__PURE__ */ jsxRuntimeExports.jsx(
      SmartSuggestions,
      {
    ...
    !hasActiveSearch && !isPomodoroActive && !showSmartSuggestions && !isLoading && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "no-results", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: 'Escribe para buscar o escribe "pomodoro" para iniciar' }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "hint", children: 'Prueba: "calcula 2+2", "convertir 100 km a millas", "wikipedia: Einstein", "pomodoro"' })
    ] }),
...
ReactDOM.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Launcher, {}) })
);
